...
namespace lee8871_support {
	...
	public :
		...
		virtual int writeU8Str(const char* name, srb::uint8 value) = 0;
		virtual int writeU8ArrayStr(const char * name, const srb::uint8 * data, int len) = 0;
		...
		virtual int writeNumArray(const char * name, const srb::uint8 * value, int len) = 0;
